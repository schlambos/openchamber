...
export type RightSidebarTab = 'git' | 'files' | 'context' | 'omo';
      ...
      }),
      {
        ...
        migrate: (persistedState, version) => {
          ...
          if (
            ...
            || (state.rightSidebarTab !== 'git' && state.rightSidebarTab !== 'files' && state.rightSidebarTab !== 'context' && state.rightSidebarTab !== 'omo')
          ) {
