...
export const dict: Record<I18nKey, string> = {
  ...
  'omoStatus.notInstalled.title': 'OMO가 설치되지 않음',
  'omoStatus.notInstalled.description': '설정을 보려면 OMO를 설치하세요.',
  'omoStatus.error.title': 'OMO 설정 로드 오류',
  'omoStatus.noConfig': 'OMO 설정을 사용할 수 없습니다',
  'omoStatus.section.agents': '에이전트',
  'omoStatus.agents.none': '구성된 에이전트 없음',
  'omoStatus.section.categories': '카테고리',
  'omoStatus.categories.none': '구성된 카테고리 없음',
  'omoStatus.section.teamMode': 'Team Mode',
  'omoStatus.teamMode.enabled': '활성화',
  'omoStatus.teamMode.on': '켜짐',
  'omoStatus.teamMode.off': '꺼짐',
  'omoStatus.teamMode.maxParallel': '최대 병렬 멤버',
  'omoStatus.teamMode.maxMembers': '최대 멤버',
  'omoStatus.editor.restartNotice': '모델 할당 변경 사항은 OMO 설정에 기록되며 OMO를 다시 시작한 후 적용됩니다.',
  'omoStatus.fallbacks.countSingle': '{count}개 fallback',
  'omoStatus.fallbacks.countPlural': '{count}개 fallback',
  'omoStatus.editor.action.edit': '편집',
  'omoStatus.editor.action.close': '닫기',
  'omoStatus.editor.action.cancel': '취소',
  'omoStatus.editor.action.save': '저장',
  'omoStatus.editor.action.saving': '저장 중...',
  'omoStatus.editor.action.addFallback': 'Fallback 추가',
  'omoStatus.editor.action.removeFallback': 'Fallback 제거',
  'omoStatus.editor.action.moveFallbackUp': 'Fallback 위로 이동',
  'omoStatus.editor.action.moveFallbackDown': 'Fallback 아래로 이동',
  'omoStatus.editor.primary': '기본 모델',
  'omoStatus.editor.fallbacks': 'Fallback 모델',
  'omoStatus.editor.fallbacks.none': 'Fallback 모델 없음',
  'omoStatus.editor.fallback.label': 'Fallback {count}',
  'omoStatus.editor.field.model': '모델',
  'omoStatus.editor.field.variant': '변형',
  'omoStatus.editor.model.placeholder': '모델 선택',
  'omoStatus.editor.variant.placeholder': '기본값',
  'omoStatus.editor.validation.modelRequired': '저장하기 전에 모델을 선택하세요.',
  'omoStatus.editor.validation.fallbackModelRequired': '저장하기 전에 각 fallback의 모델을 선택하세요.',
  'omoStatus.editor.toast.savedRestartRequired': 'OMO 설정이 저장되었습니다. 변경 사항을 적용하려면 OMO를 다시 시작하세요.',
  'omoStatus.editor.toast.saveFailed': 'OMO 설정 저장 실패',
