...
export const dict: Record<I18nKey, string> = {
  ...
  "omoStatus.notInstalled.title": "OMO no instalado",
  "omoStatus.notInstalled.description": "Instala OMO para ver su configuración.",
  "omoStatus.error.title": "Error al cargar la configuración de OMO",
  "omoStatus.noConfig": "No hay configuración de OMO disponible",
  "omoStatus.section.agents": "Agentes",
  "omoStatus.agents.none": "Sin agentes configurados",
  "omoStatus.section.categories": "Categorías",
  "omoStatus.categories.none": "Sin categorías configuradas",
  "omoStatus.section.teamMode": "Team Mode",
  "omoStatus.teamMode.enabled": "Habilitado",
  "omoStatus.teamMode.on": "Activado",
  "omoStatus.teamMode.off": "Desactivado",
  "omoStatus.teamMode.maxParallel": "Máx. miembros paralelos",
  "omoStatus.teamMode.maxMembers": "Máx. miembros",
  "omoStatus.editor.restartNotice": "Los cambios de asignación de modelo se escriben en la configuración de OMO y se aplican después de reiniciar OMO.",
  ...
  "omoStatus.editor.action.close": "Cerrar",
  "omoStatus.editor.action.cancel": "Cancelar",
  "omoStatus.editor.action.save": "Guardar",
  "omoStatus.editor.action.saving": "Guardando...",
  "omoStatus.editor.action.addFallback": "Añadir fallback",
  "omoStatus.editor.action.removeFallback": "Eliminar fallback",
  "omoStatus.editor.action.moveFallbackUp": "Subir fallback",
  "omoStatus.editor.action.moveFallbackDown": "Bajar fallback",
  "omoStatus.editor.primary": "Modelo principal",
  "omoStatus.editor.fallbacks": "Modelos fallback",
  "omoStatus.editor.fallbacks.none": "Sin modelos fallback",
  "omoStatus.editor.fallback.label": "Fallback {count}",
  "omoStatus.editor.field.model": "Modelo",
  "omoStatus.editor.field.variant": "Variante",
  "omoStatus.editor.model.placeholder": "Seleccionar modelo",
  "omoStatus.editor.variant.placeholder": "Predeterminado",
  "omoStatus.editor.validation.modelRequired": "Elige un modelo antes de guardar.",
  "omoStatus.editor.validation.fallbackModelRequired": "Elige un modelo para cada fallback antes de guardar.",
  "omoStatus.editor.toast.savedRestartRequired": "Configuración de OMO guardada. Reinicia OMO para aplicar los cambios.",
  "omoStatus.editor.toast.saveFailed": "No se pudo guardar la configuración de OMO",
