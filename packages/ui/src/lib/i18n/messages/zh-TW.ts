...
export const dict: Record<I18nKey, string> = {
  ...
  'omoStatus.notInstalled.title': 'OMO 未安裝',
  'omoStatus.notInstalled.description': '安裝 OMO 以查看其配置。',
  'omoStatus.error.title': '載入 OMO 配置時出錯',
  'omoStatus.noConfig': '沒有可用的 OMO 配置',
  'omoStatus.section.agents': '代理',
  'omoStatus.agents.none': '未配置代理',
  'omoStatus.section.categories': '類別',
  'omoStatus.categories.none': '未配置類別',
  'omoStatus.section.teamMode': 'Team Mode',
  'omoStatus.teamMode.enabled': '已啟用',
  'omoStatus.teamMode.on': '開',
  'omoStatus.teamMode.off': '關',
  'omoStatus.teamMode.maxParallel': '最大並行成員',
  'omoStatus.teamMode.maxMembers': '最大成員',
  'omoStatus.editor.restartNotice': '模型分配變更會寫入 OMO 配置，並在 OMO 重新啟動後生效。',
  'omoStatus.fallbacks.countSingle': '{count} 個備用',
  'omoStatus.fallbacks.countPlural': '{count} 個備用',
  'omoStatus.editor.action.edit': '編輯',
  'omoStatus.editor.action.close': '關閉',
  'omoStatus.editor.action.cancel': '取消',
  'omoStatus.editor.action.save': '儲存',
  'omoStatus.editor.action.saving': '正在儲存...',
  'omoStatus.editor.action.addFallback': '新增備用',
  'omoStatus.editor.action.removeFallback': '移除備用',
  'omoStatus.editor.action.moveFallbackUp': '上移備用',
  'omoStatus.editor.action.moveFallbackDown': '下移備用',
  'omoStatus.editor.primary': '主要模型',
  'omoStatus.editor.fallbacks': '備用模型',
  'omoStatus.editor.fallbacks.none': '沒有備用模型',
  'omoStatus.editor.fallback.label': '備用 {count}',
  'omoStatus.editor.field.model': '模型',
  'omoStatus.editor.field.variant': '變體',
  'omoStatus.editor.model.placeholder': '選擇模型',
  'omoStatus.editor.variant.placeholder': '預設',
  'omoStatus.editor.validation.modelRequired': '儲存前請選擇模型。',
  'omoStatus.editor.validation.fallbackModelRequired': '儲存前請為每個備用項目選擇模型。',
  'omoStatus.editor.toast.savedRestartRequired': 'OMO 配置已儲存。重新啟動 OMO 以套用變更。',
  'omoStatus.editor.toast.saveFailed': '儲存 OMO 配置失敗',
