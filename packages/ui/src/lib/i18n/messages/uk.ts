...
export const dict: Record<I18nKey, string> = {
  ...
  "omoStatus.notInstalled.title": "OMO не встановлено",
  "omoStatus.notInstalled.description": "Встановіть OMO, щоб побачити його конфігурацію.",
  "omoStatus.error.title": "Помилка завантаження конфігурації OMO",
  "omoStatus.noConfig": "Конфігурація OMO недоступна",
  "omoStatus.section.agents": "Агенти",
  "omoStatus.agents.none": "Немає налаштованих агентів",
  "omoStatus.section.categories": "Категорії",
  "omoStatus.categories.none": "Немає налаштованих категорій",
  "omoStatus.section.teamMode": "Team Mode",
  "omoStatus.teamMode.enabled": "Увімкнено",
  "omoStatus.teamMode.on": "Увімк.",
  "omoStatus.teamMode.off": "Вимк.",
  "omoStatus.teamMode.maxParallel": "Макс. паралельних учасників",
  "omoStatus.teamMode.maxMembers": "Макс. учасників",
  "omoStatus.editor.restartNotice": "Зміни призначення моделей записуються в конфігурацію OMO і застосовуються після перезапуску OMO.",
  "omoStatus.fallbacks.countSingle": "{count} fallback",
  "omoStatus.fallbacks.countPlural": "{count} fallback-и",
  "omoStatus.editor.action.edit": "Редагувати",
  "omoStatus.editor.action.close": "Закрити",
  "omoStatus.editor.action.cancel": "Скасувати",
  "omoStatus.editor.action.save": "Зберегти",
  "omoStatus.editor.action.saving": "Збереження...",
  "omoStatus.editor.action.addFallback": "Додати fallback",
  "omoStatus.editor.action.removeFallback": "Видалити fallback",
  "omoStatus.editor.action.moveFallbackUp": "Перемістити fallback вгору",
  "omoStatus.editor.action.moveFallbackDown": "Перемістити fallback вниз",
  "omoStatus.editor.primary": "Основна модель",
  "omoStatus.editor.fallbacks": "Fallback-моделі",
  "omoStatus.editor.fallbacks.none": "Немає fallback-моделей",
  "omoStatus.editor.fallback.label": "Fallback {count}",
  "omoStatus.editor.field.model": "Модель",
  "omoStatus.editor.field.variant": "Варіант",
  "omoStatus.editor.model.placeholder": "Вибрати модель",
  "omoStatus.editor.variant.placeholder": "За замовчуванням",
  "omoStatus.editor.validation.modelRequired": "Виберіть модель перед збереженням.",
  "omoStatus.editor.validation.fallbackModelRequired": "Виберіть модель для кожного fallback перед збереженням.",
  "omoStatus.editor.toast.savedRestartRequired": "Конфігурацію OMO збережено. Перезапустіть OMO, щоб застосувати зміни.",
  "omoStatus.editor.toast.saveFailed": "Не вдалося зберегти конфігурацію OMO",
