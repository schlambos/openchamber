...
export const dict: Record<I18nKey, string> = {
  ...
  'omoStatus.notInstalled.title': 'OMO 未安装',
  'omoStatus.notInstalled.description': '安装 OMO 以查看其配置。',
  'omoStatus.error.title': '加载 OMO 配置时出错',
  'omoStatus.noConfig': '没有可用的 OMO 配置',
  'omoStatus.section.agents': '代理',
  'omoStatus.agents.none': '未配置代理',
  'omoStatus.section.categories': '类别',
  'omoStatus.categories.none': '未配置类别',
  'omoStatus.section.teamMode': 'Team Mode',
  'omoStatus.teamMode.enabled': '已启用',
  'omoStatus.teamMode.on': '开',
  'omoStatus.teamMode.off': '关',
  'omoStatus.teamMode.maxParallel': '最大并行成员',
  'omoStatus.teamMode.maxMembers': '最大成员',
  'omoStatus.editor.restartNotice': '模型分配更改会写入 OMO 配置，并在 OMO 重启后生效。',
  'omoStatus.fallbacks.countSingle': '{count} 个备用',
  'omoStatus.fallbacks.countPlural': '{count} 个备用',
  'omoStatus.editor.action.edit': '编辑',
  'omoStatus.editor.action.close': '关闭',
  'omoStatus.editor.action.cancel': '取消',
  'omoStatus.editor.action.save': '保存',
  'omoStatus.editor.action.saving': '正在保存...',
  'omoStatus.editor.action.addFallback': '添加备用',
  'omoStatus.editor.action.removeFallback': '移除备用',
  'omoStatus.editor.action.moveFallbackUp': '上移备用',
  'omoStatus.editor.action.moveFallbackDown': '下移备用',
  'omoStatus.editor.primary': '主模型',
  'omoStatus.editor.fallbacks': '备用模型',
  'omoStatus.editor.fallbacks.none': '没有备用模型',
  'omoStatus.editor.fallback.label': '备用 {count}',
  'omoStatus.editor.field.model': '模型',
  'omoStatus.editor.field.variant': '变体',
  'omoStatus.editor.model.placeholder': '选择模型',
  'omoStatus.editor.variant.placeholder': '默认',
  'omoStatus.editor.validation.modelRequired': '保存前请选择模型。',
  'omoStatus.editor.validation.fallbackModelRequired': '保存前请为每个备用项选择模型。',
  'omoStatus.editor.toast.savedRestartRequired': 'OMO 配置已保存。重启 OMO 以应用更改。',
  'omoStatus.editor.toast.saveFailed': '保存 OMO 配置失败',
