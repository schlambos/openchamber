...
export const dict = {
  ...
  'omoStatus.notInstalled.title': 'OMO Not Installed',
  'omoStatus.notInstalled.description': 'Install OMO to see its configuration.',
  'omoStatus.error.title': 'Error Loading OMO Config',
  'omoStatus.noConfig': 'No OMO config available',
  'omoStatus.section.agents': 'Agents',
  'omoStatus.agents.none': 'No agents configured',
  'omoStatus.section.categories': 'Categories',
  'omoStatus.categories.none': 'No categories configured',
  'omoStatus.section.teamMode': 'Team Mode',
  'omoStatus.teamMode.enabled': 'Enabled',
  'omoStatus.teamMode.on': 'On',
  'omoStatus.teamMode.off': 'Off',
  'omoStatus.teamMode.maxParallel': 'Max parallel members',
  'omoStatus.teamMode.maxMembers': 'Max members',
  'omoStatus.editor.restartNotice': 'Model assignment changes are written to the OMO config and apply after OMO restarts.',
  'omoStatus.fallbacks.countSingle': '{count} fallback',
  'omoStatus.fallbacks.countPlural': '{count} fallbacks',
  'omoStatus.editor.action.edit': 'Edit',
  'omoStatus.editor.action.close': 'Close',
  'omoStatus.editor.action.cancel': 'Cancel',
  'omoStatus.editor.action.save': 'Save',
  'omoStatus.editor.action.saving': 'Saving...',
  'omoStatus.editor.action.addFallback': 'Add fallback',
  'omoStatus.editor.action.removeFallback': 'Remove fallback',
  'omoStatus.editor.action.moveFallbackUp': 'Move fallback up',
  'omoStatus.editor.action.moveFallbackDown': 'Move fallback down',
  'omoStatus.editor.primary': 'Primary model',
  'omoStatus.editor.fallbacks': 'Fallback models',
  'omoStatus.editor.fallbacks.none': 'No fallback models',
  'omoStatus.editor.fallback.label': 'Fallback {count}',
  'omoStatus.editor.field.model': 'Model',
  'omoStatus.editor.field.variant': 'Variant',
  'omoStatus.editor.model.placeholder': 'Select model',
  'omoStatus.editor.variant.placeholder': 'Default',
  'omoStatus.editor.validation.modelRequired': 'Choose a model before saving.',
  'omoStatus.editor.validation.fallbackModelRequired': 'Choose a model for each fallback before saving.',
  'omoStatus.editor.toast.savedRestartRequired': 'OMO config saved. Restart OMO to apply changes.',
  'omoStatus.editor.toast.saveFailed': 'Failed to save OMO config',
