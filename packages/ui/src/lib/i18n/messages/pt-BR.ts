...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "omoStatus.notInstalled.title": "OMO não instalado",
  "omoStatus.notInstalled.description": "Instale o OMO para ver sua configuração.",
  "omoStatus.error.title": "Erro ao carregar configuração do OMO",
  "omoStatus.noConfig": "Nenhuma configuração do OMO disponível",
  "omoStatus.section.agents": "Agentes",
  "omoStatus.agents.none": "Nenhum agente configurado",
  "omoStatus.section.categories": "Categorias",
  "omoStatus.categories.none": "Nenhuma categoria configurada",
  "omoStatus.section.teamMode": "Team Mode",
  "omoStatus.teamMode.enabled": "Habilitado",
  "omoStatus.teamMode.on": "Ligado",
  "omoStatus.teamMode.off": "Desligado",
  "omoStatus.teamMode.maxParallel": "Máx. membros paralelos",
  "omoStatus.teamMode.maxMembers": "Máx. membros",
  "omoStatus.editor.restartNotice": "As alterações de atribuição de modelo são gravadas na configuração do OMO e entram em vigor após reiniciar o OMO.",
  "omoStatus.fallbacks.countSingle": "{count} fallback",
  "omoStatus.fallbacks.countPlural": "{count} fallbacks",
  "omoStatus.editor.action.edit": "Editar",
  "omoStatus.editor.action.close": "Fechar",
  "omoStatus.editor.action.cancel": "Cancelar",
  "omoStatus.editor.action.save": "Salvar",
  "omoStatus.editor.action.saving": "Salvando...",
  "omoStatus.editor.action.addFallback": "Adicionar fallback",
  "omoStatus.editor.action.removeFallback": "Remover fallback",
  "omoStatus.editor.action.moveFallbackUp": "Mover fallback para cima",
  "omoStatus.editor.action.moveFallbackDown": "Mover fallback para baixo",
  "omoStatus.editor.primary": "Modelo principal",
  "omoStatus.editor.fallbacks": "Modelos fallback",
  "omoStatus.editor.fallbacks.none": "Nenhum modelo fallback",
  "omoStatus.editor.fallback.label": "Fallback {count}",
  "omoStatus.editor.field.model": "Modelo",
  "omoStatus.editor.field.variant": "Variante",
  "omoStatus.editor.model.placeholder": "Selecionar modelo",
  "omoStatus.editor.variant.placeholder": "Padrão",
  "omoStatus.editor.validation.modelRequired": "Escolha um modelo antes de salvar.",
  "omoStatus.editor.validation.fallbackModelRequired": "Escolha um modelo para cada fallback antes de salvar.",
  "omoStatus.editor.toast.savedRestartRequired": "Configuração do OMO salva. Reinicie o OMO para aplicar as alterações.",
  "omoStatus.editor.toast.saveFailed": "Falha ao salvar configuração do OMO",
