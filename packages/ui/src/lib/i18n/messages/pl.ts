...
export const dict: Record<I18nKey, string> = {
  ...
  'omoStatus.notInstalled.title': 'OMO nie zainstalowane',
  'omoStatus.notInstalled.description': 'Zainstaluj OMO, aby zobaczyć jego konfigurację.',
  'omoStatus.error.title': 'Błąd ładowania konfiguracji OMO',
  'omoStatus.noConfig': 'Brak konfiguracji OMO',
  'omoStatus.section.agents': 'Agenci',
  'omoStatus.agents.none': 'Brak skonfigurowanych agentów',
  'omoStatus.section.categories': 'Kategorie',
  'omoStatus.categories.none': 'Brak skonfigurowanych kategorii',
  'omoStatus.section.teamMode': 'Team Mode',
  'omoStatus.teamMode.enabled': 'Włączone',
  'omoStatus.teamMode.on': 'Wł.',
  'omoStatus.teamMode.off': 'Wył.',
  'omoStatus.teamMode.maxParallel': 'Maks. równoległych członków',
  'omoStatus.teamMode.maxMembers': 'Maks. członków',
  'omoStatus.editor.restartNotice': 'Zmiany przypisania modeli są zapisywane w konfiguracji OMO i obowiązują po ponownym uruchomieniu OMO.',
  'omoStatus.fallbacks.countSingle': '{count} fallback',
  'omoStatus.fallbacks.countPlural': '{count} fallbacki',
  'omoStatus.editor.action.edit': 'Edytuj',
  'omoStatus.editor.action.close': 'Zamknij',
  'omoStatus.editor.action.cancel': 'Anuluj',
  'omoStatus.editor.action.save': 'Zapisz',
  'omoStatus.editor.action.saving': 'Zapisywanie...',
  'omoStatus.editor.action.addFallback': 'Dodaj fallback',
  'omoStatus.editor.action.removeFallback': 'Usuń fallback',
  'omoStatus.editor.action.moveFallbackUp': 'Przenieś fallback wyżej',
  'omoStatus.editor.action.moveFallbackDown': 'Przenieś fallback niżej',
  'omoStatus.editor.primary': 'Model główny',
  'omoStatus.editor.fallbacks': 'Modele fallback',
  'omoStatus.editor.fallbacks.none': 'Brak modeli fallback',
  'omoStatus.editor.fallback.label': 'Fallback {count}',
  'omoStatus.editor.field.model': 'Model',
  'omoStatus.editor.field.variant': 'Wariant',
  'omoStatus.editor.model.placeholder': 'Wybierz model',
  'omoStatus.editor.variant.placeholder': 'Domyślny',
  'omoStatus.editor.validation.modelRequired': 'Wybierz model przed zapisaniem.',
  'omoStatus.editor.validation.fallbackModelRequired': 'Wybierz model dla każdego fallbacku przed zapisaniem.',
  'omoStatus.editor.toast.savedRestartRequired': 'Konfiguracja OMO zapisana. Uruchom ponownie OMO, aby zastosować zmiany.',
  'omoStatus.editor.toast.saveFailed': 'Nie udało się zapisać konfiguracji OMO',
